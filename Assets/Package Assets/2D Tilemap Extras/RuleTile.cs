...
namespace UnityEngine
{
    ...
    /// </summary>
    [Serializable]
    [CreateAssetMenu(menuName = "Parallax Tiles/Auto Tile", fileName = "Auto Tile")]
    public class RuleTile : ParallaxTileBase
    {
        /// <summary>
        ...
        public override bool StartUp(Vector3Int location, ITilemap tilemap, GameObject instantiatedGameObject)
        {
            ...
            if (instantiatedGameObject != null)
            {
                ...
                float z_offset = is_terrain ? 0.5f : 0;
                ...
                {   
                    ...
                    if (RuleMatches(rule, location, tilemap, ref transform))
                    {
                        ...
                        gameObjectTranslation = new Vector3(transform.m03, transform.m13, transform.m23 + z_offset);
                ...
                if (!ruleMatched)
                {
                    ...
                    gameObjectTranslation = new Vector3(orientMatrix.m03, orientMatrix.m13, orientMatrix.m23 + z_offset);
